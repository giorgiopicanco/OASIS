...
import gnss_freqs
from levelling_settings import *
...
estacao = sys.argv[1]  # O primeiro argumento é o nome do próprio script, então pegamos os argumentos a partir do segundo até o antepenúltimo
doy = sys.argv[2]  # O penúltimo argumento
ano = sys.argv[3]  # O último argumento
diretorio_principal = sys.argv[4]  # O último argumento
...
for sat_class in sat_classes:
    ...
    for satellite in satellites_to_plot:
        ...
        L_GF = geometry_free_combination_L(lambda1, lambda2, L1_array, L2_array)
        P_GF = geometry_free_combination_C(P1_array, P2_array)

        L_GF15 = geometry_free_combination_L(lambda1, lambda5, L1_array, L5_array)
        P_GF15 = geometry_free_combination_C(P1_array, P5_array)

        L_GF25 = geometry_free_combination_L(lambda2, lambda5, L2_array, L5_array)
        P_GF25 = geometry_free_combination_C(P2_array, P5_array)
        ...
        for i, arc in enumerate(arcos):
            ...
            polynomial_fit = fit_polynomial(x_values, arc_values, 3)  # Assumindo que esta função realiza o ajuste polinomial corretamente   #DIA=1.5

            x_values2 = np.arange(len(arc_values2))
            polynomial_fit2 = fit_polynomial(x_values2, arc_values2, 3)  # Mesmo para o segundo conjunto de valores
    ...
    # # Substituindo a extensão .txt por .png
